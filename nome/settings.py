"""
Django settings for nome project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'inicio.novos_context.lista_sindicancia',
            ],
        },
    },
]

WSGI_APPLICATION = 'nome.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'canetex_db',       # Nome que criamos no MariaDB
        'USER': 'root',
        'PASSWORD': 'indio2272',
        'HOST': 'db_mestre',
        'PORT': '3306',
