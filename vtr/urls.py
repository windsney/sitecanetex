...
from .views import (
    ...
    ViaturaCreateView, 
    ViaturaUpdateView, 
    ViaturaDeleteView,PainelEfetivoView,EfetivoNominalUnidadeView)
...
urlpatterns = [
    ...
    path('efetivo/', PainelEfetivoView.as_view(), name='efetivo'),
    path('efetivo/unidade/<int:pk>/', EfetivoNominalUnidadeView.as_view(), name='efetivo_nominal'),
